...
class LMFeedLabelImageContainerView : ConstraintLayout {
    ...
    private var labelImageContainerViewStyle: LMFeedLabelImageContainerViewStyle? = null
    ...
    fun setContainerImage(imageSrc: Any) {
        labelImageContainerViewStyle?.containerImageStyle?.let {
            binding.ivContainer.setImage(imageSrc, it)
        }
    }
