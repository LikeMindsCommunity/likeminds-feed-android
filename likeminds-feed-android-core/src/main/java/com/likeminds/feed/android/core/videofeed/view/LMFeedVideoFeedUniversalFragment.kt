...
import com.likeminds.feed.android.core.databinding.LmFeedFragmentVideoFeedUniversalBinding
...
open class LMFeedVideoFeedUniversalFragment(private val config: LMFeedVideoFeedConfig? = null) :
    ...
    lateinit var binding: LmFeedFragmentVideoFeedUniversalBinding
    ...
    override fun onCreateView(
        ...
        binding = LmFeedFragmentVideoFeedUniversalBinding.inflate(layoutInflater)
    ...
    private fun setupVideoFeed() {
        binding.vp2VideoFeed.apply {
            ...
            videoFeedAdapter = LMFeedVideoFeedAdapter(this@LMFeedVideoFeedUniversalFragment)
        }
    }
