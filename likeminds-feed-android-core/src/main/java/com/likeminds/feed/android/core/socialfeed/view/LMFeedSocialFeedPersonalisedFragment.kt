...
import com.likeminds.feed.android.core.databinding.LmFeedFragmentSocialFeedPersonalisedBinding
...
open class LMFeedSocialFeedPersonalisedFragment :
    ...
    private lateinit var binding: LmFeedFragmentSocialFeedPersonalisedBinding
    ...
    override fun onCreateView(
        ...
        binding = LmFeedFragmentSocialFeedPersonalisedBinding.inflate(layoutInflater)

        binding.apply {
            rvSocial.initAdapterAndSetListener(this@LMFeedSocialFeedPersonalisedFragment)
            ...
            val paginationScrollListener =
                object : LMFeedEndlessRecyclerViewScrollListener(linearLayoutManager) {
                    override fun onLoadMore(currentPage: Int) {
                        if (currentPage > 0) {
                            socialFeedViewModel.postViewModel.getPersonalisedFeed(currentPage)
                        }
                    }
                }
