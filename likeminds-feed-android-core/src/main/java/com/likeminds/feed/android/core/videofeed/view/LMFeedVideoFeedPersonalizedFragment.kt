...
import com.likeminds.feed.android.core.databinding.LmFeedFragmentVideoFeedPersonalisedBinding
...
open class LMFeedVideoFeedPersonalizedFragment(private val config: LMFeedVideoFeedConfig? = null) :
    Fragment(),
    LMFeedPostAdapterListener,
    LMFeedPostMenuBottomSheetListener,
    LMFeedVideoPlayerListener {

    lateinit var binding: LmFeedFragmentVideoFeedPersonalisedBinding
    ...
    companion object {
        ...
        @JvmStatic
        fun getInstance(config: LMFeedVideoFeedConfig?): LMFeedVideoFeedPersonalizedFragment {
            return LMFeedVideoFeedPersonalizedFragment(config)
        }
    }
    ...
    override fun onCreateView(
        ...
        binding = LmFeedFragmentVideoFeedPersonalisedBinding.inflate(layoutInflater)
    ...
    private fun setupVideoFeed() {
        binding.vp2VideoFeed.apply {
            ...
            videoFeedAdapter = LMFeedVideoFeedAdapter(this@LMFeedVideoFeedPersonalizedFragment)
        }
    }
    ...
    private fun observeResponses() {
        ...
        videoFeedViewModel.postViewModel.errorMessageEventFlow.onEach { response ->
            when (response) {
                is LMFeedPostViewModel.ErrorMessageEvent.PersonalisedFeed -> {
