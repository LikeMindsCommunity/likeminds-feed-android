...
import com.likeminds.feed.android.core.databinding.LmFeedFragmentSocialFeedUniversalBinding
...
open class LMFeedSocialFeedUniversalFragment :
    ...
    private lateinit var binding: LmFeedFragmentSocialFeedUniversalBinding
    ...
    override fun onCreateView(
        ...
        binding = LmFeedFragmentSocialFeedUniversalBinding.inflate(layoutInflater)

        binding.apply {
            rvSocial.initAdapterAndSetListener(this@LMFeedSocialFeedUniversalFragment)
    ...
    private fun initSelectedTopicRecyclerView() {
        binding.topicSelectorBar.apply {
            ...
            setSelectedTopicAdapter(this@LMFeedSocialFeedUniversalFragment)
