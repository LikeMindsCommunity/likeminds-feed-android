 ...
 * @property selectedPollResultsTabColor : [Int] should be in format of [ColorRes] this will help you to customize the selected poll results tab color in the poll results fragment | Default value = [LMFeedThemeConstants.getButtonColor]
...
class LMFeedPollResultsFragmentViewStyle private constructor(
    ...
    class Builder {
        ...
        @ColorRes
        private var selectedPollResultsTabColor: Int = LMFeedThemeConstants.getButtonColor()
